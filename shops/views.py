...
def contact(request):
    if request.method == 'POST':
        ...
        sender = f'From: {data.get("fname")} {data.get("lname")} <{data.get("email")}>'
        subject = f"Collision-Aid: {data.get('subject')}"
        body = f'Message Body: {data.get("message")}'
        message = f'{sender}\nSubject: {data.get("subject")}\n\n{body}\n\n---------\nThis email was generated by a contact form on https://www.collision-aid.ca/'
        try:
